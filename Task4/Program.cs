namespace Task4
{
    internal class Program
    {
       ...
       */
        ...
        {
            string filePath = @"C:\Users\Алла\source\repos\Module8\Task4\SampleDataFile\students.dat";
            string filePathForFolderStudents = @"C:\Users\Алла\Рабочий стол\Students";
        ...
        static List<Student> FillStudenstList()
        {
            ...
            {
                new Student{Name="Иван Абрамов", Group="Группа1", DateOfBirth=new DateTime(2007,01,23), AverageScore=4.6M},
                new Student{Name="Олег Щербаков", Group="Группа2", DateOfBirth=new DateTime(2006,05,15), AverageScore=3.1M},
                new Student{Name="Игорь Николаев", Group="Группа3", DateOfBirth=new DateTime(2006,10,01), AverageScore=3.9M},
                new Student{Name="Алена Апина", Group="Группа1", DateOfBirth=new DateTime(2007,12,14), AverageScore=4.1M},
                new Student{Name="Ирина Алегрова", Group="Группа2", DateOfBirth=new DateTime(2006,04,21), AverageScore=3.2M},
                new Student{Name="Анна Семенович", Group="Группа3", DateOfBirth=new DateTime(2007,02,03), AverageScore=4.0M},
                new Student{Name="Николай Басков", Group="Группа1", DateOfBirth=new DateTime(2006,07,18), AverageScore=4.9M},
                new Student{Name="Надежда Кадышева", Group="Группа2", DateOfBirth=new DateTime(2007,11,27), AverageScore=3.4M},
                new Student{Name="Алексей Нилов", Group="Группа3", DateOfBirth=new DateTime(2007,08,01), AverageScore=3.3M},
            };
            return students;
        }
        ...
        static void FilesInFolderCreate(ref List<FileInfo> files)
        {
            ...
            {
            new FileInfo(@"C:\Users\Алла\Рабочий стол\Students\Группа1.txt"),
            new FileInfo(@"C:\Users\Алла\Рабочий стол\Students\Группа2.txt"),
            new FileInfo(@"C:\Users\Алла\Рабочий стол\Students\Группа3.txt"),
            };
        ...
        {
            using (FileStream fileStream = new FileStream($"C:\\Users\\Алла\\Рабочий стол\\Students\\{group}.txt", FileMode.Create, FileAccess.Write))
            {
